...
/**
 * x710
 * For this question you will be given a reference to a node in a linkedList and a new value (not in the linkedList). Write a method that inserts a new node containing that value after the node passed in.
 * So if you have a linkedList that looks like: "A" --> "B"--> "D" and this method gets called with a reference to the node containing "B" and the string "C", update the linkedList to be "A" --> "B"--> "C" --> "D"
 */
